...
// PAWテーマ（犬と猫の両方対応）
export const pawTheme: ThemeConfig = {
  colors: {
    primary: '#9333EA', // 紫
    secondary: '#A855F7',
    accent: '#DDD6FE',
  ...
  gradients: {
    ...
    secondary: 'linear-gradient(135deg, #A855F7 0%, #DDD6FE 100%)',
    card: 'linear-gradient(145deg, #FFFFFF 0%, #F9FAFB 100%)',
  },
  shadows: {
    card: '0 10px 25px -3px rgba(147, 51, 234, 0.1), 0 4px 6px -2px rgba(147, 51, 234, 0.05)',
    button: '0 4px 14px 0 rgba(147, 51, 234, 0.25)',
  },
}
