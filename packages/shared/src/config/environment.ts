...
const environments: Record<string, Environment> = {
  development: {
    name: 'development',
    api: {
      animals: (typeof import.meta !== 'undefined' && import.meta.env?.VITE_ANIMALS_API) || 'http://localhost:8787',
      users: (typeof import.meta !== 'undefined' && import.meta.env?.VITE_USERS_API) || 'http://localhost:8788',
      matching: (typeof import.meta !== 'undefined' && import.meta.env?.VITE_MATCHING_API) || 'http://localhost:8789',
      notifications: (typeof import.meta !== 'undefined' && import.meta.env?.VITE_NOTIFICATIONS_API) || 'http://localhost:8790'
    },
    enableDebug: true,
...
export const getCurrentEnvironment = (): Environment => {
  const envName = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_ENVIRONMENT) || 'development';
