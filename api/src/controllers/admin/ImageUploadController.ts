...
export class ImageUploadController {
  ...
  async batchUpload(c: Context<{ Bindings: Env }>): Promise<Response> {
    try {
      ...
      for (const pet of results) {
        try {
          ...
          if (pet.screenshot) {
            ...
            uploadTasks.push(
              this.r2.put(screenshotKey, screenshotBuffer, {
          ...
          if (pet.jpeg) {
            ...
            uploadTasks.push(
              this.r2.put(jpegKey, jpegBuffer, {
          ...
          if (pet.webp) {
            ...
            uploadTasks.push(
              this.r2.put(webpKey, webpBuffer, {
      ...
      console.log(`[batch-upload] Batch ${batchId} complete: ${successful}/${results.length} successful`);
